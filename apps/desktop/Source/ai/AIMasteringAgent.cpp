    ...
    Features& features)
{
    ...
    float totalEnergy = features.subBass + features.bass + features.lowMid + 
                       features.mid + features.highMid + features.presence + features.brilliance;
...
Dynamic Range: )" + juce::String(dynamicRange, 1) + R"( dB
    ...
    const juce::String& response)
{
    ...
    DBG("║                                                            ║");
    DBG("║ Compression:                                               ║");
    DBG("║   Threshold:  " + juce::String(decision.compression.threshold, 1) + " dB");
    DBG("║   Ratio:      " + juce::String(decision.compression.ratio, 1) + ":1");
    DBG("║   Attack:     " + juce::String(decision.compression.attack, 0) + " ms");
    DBG("║   Release:    " + juce::String(decision.compression.release, 0) + " ms");
    DBG("║                                                            ║");
    DBG("║ Limiter:      " + juce::String(decision.limiterCeiling, 2) + " dB ceiling");
    DBG("╠════════════════════════════════════════════════════════════╣");
    DBG("║ AI Reasoning:                                              ║");
    ...
    float targetLoudness)
{
    ...
    juce::String systemMsg = R"(You are a professional mastering engineer with decades of experience at top studios. 
