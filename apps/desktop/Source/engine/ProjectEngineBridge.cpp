...
ProjectEngineBridge::ProjectEngineBridge(ProjectState &projectState,
                                         Engine &engine)
...
void ProjectEngineBridge::start(int automationUpdateRateHz) {
  ...
  DBG("ProjectEngineBridge: Starting with " +
      juce::String(automationUpdateRateHz) + " Hz automation update");
...
void ProjectEngineBridge::valueTreeChildAdded(juce::ValueTree &parent,
...
void ProjectEngineBridge::valueTreeChildRemoved(juce::ValueTree &parent,
                                                juce::ValueTree &child,
                                                int index) {
...
void ProjectEngineBridge::valueTreeChildOrderChanged(juce::ValueTree &parent,
                                                     int oldIndex,
                                                     int newIndex) {
...
void ProjectEngineBridge::syncTrackProperty(const juce::ValueTree &track,
...
void ProjectEngineBridge::syncClipProperty(const juce::ValueTree &clip,
                                           const juce::Identifier &property) {
  if (!clip.isValid())
    return;
...
int ProjectEngineBridge::getEngineTrackIndex(
...
double ProjectEngineBridge::sampleEnvelope(const juce::ValueTree &envelope,
  ...
  juce::String curveType =
      prevPoint.getProperty(ProjectState::PROP_CURVE_TYPE, "linear").toString();
...
void ProjectEngineBridge::rebuildTrackMapping() {
  ...
  DBG("ProjectEngineBridge: Rebuilt mapping for " +
      juce::String(trackIdToIndex_.size()) + " tracks");
}
