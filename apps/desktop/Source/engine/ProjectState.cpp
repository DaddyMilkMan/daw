...
void ProjectState::createDefaultState() {
     ...
     // System containers must have IDs for CRDT sync
     auto tracks = state.getOrCreateChildWithName(ID_TRACKS, nullptr);
     tracks.setProperty(PROP_ID, "sys_tracks", nullptr);
     
     auto markers = state.getOrCreateChildWithName(ID_MARKERS, nullptr);
     markers.setProperty(PROP_ID, "sys_markers", nullptr);
     
     auto tempo = state.getOrCreateChildWithName(ID_TEMPO_MAP, nullptr);
     tempo.setProperty(PROP_ID, "sys_tempo", nullptr);
     
     auto sections = state.getOrCreateChildWithName(ID_SECTIONS, nullptr);
     sections.setProperty(PROP_ID, "sys_sections", nullptr);
