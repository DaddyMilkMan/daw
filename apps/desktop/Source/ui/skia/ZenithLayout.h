...
public:
     ...
     */
    static void row(const juce::Rectangle<int>& bounds, 
                   const std::vector<juce::Component*>& items, 
                   float gap = 10.0f,
                   juce::FlexBox::JustifyContent justify = juce::FlexBox::JustifyContent::flexStart,
                   juce::FlexBox::AlignItems align = juce::FlexBox::AlignItems::center);

    /**
     * @brief Arranges components in a vertical column
     */
    static void column(const juce::Rectangle<int>& bounds, 
                      const std::vector<juce::Component*>& items, 
                      float gap = 10.0f,
                      juce::FlexBox::JustifyContent justify = juce::FlexBox::JustifyContent::flexStart,
                      juce::FlexBox::AlignItems align = juce::FlexBox::AlignItems::center);
    ...
    public:
        ...
        Builder& withBounds(const juce::Rectangle<int>& bounds) { bounds_ = bounds; return *this; }
        Builder& withGap(float gap) { gap_ = gap; return *this; }
        Builder& withJustify(juce::FlexBox::JustifyContent justify) { justify_ = justify; return *this; }
        Builder& withAlign(juce::FlexBox::AlignItems align) { align_ = align; return *this; }
        Builder& withItems(const std::vector<juce::Component*>& items) { items_ = items; return *this; }
        Builder& addItem(juce::Component* item) { items_.push_back(item); return *this; }
    ...
    private:
        ...
        float gap_ = 0.0f;
        juce::FlexBox::JustifyContent justify_ = juce::FlexBox::JustifyContent::flexStart;
