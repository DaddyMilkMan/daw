/*
  ==============================================================================
    ...
    Decouples JUCE Component state (Message Thread) from Skia rendering (OpenGL Thread).
  ==============================================================================
*/
...
struct KnobRenderState {
    ...
    KnobRenderState() 
        ...
        , isHovered(false)
        , isDragging(false)
        , baseColor(SK_ColorCYAN)
        , glowColor(SK_ColorCYAN)
        , glowIntensity(0.0f)
        , scale(1.0f)
        , displayMin(0.0f)
        , displayMax(1.0f)
 ...
 * - Render Thread: Reads from "render" buffer, swaps from "ready" when available
 * 
 * This ensures:
 * - Zero locks/mutexes
 * - Zero frame drops
