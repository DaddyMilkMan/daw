      ...
      pluginHost_(pluginHost)
{
    ...
    blacklistList_.setColour(juce::ListBox::outlineColourId, juce::Colours::grey);
    ...
    detailsEditor_.setColour(juce::TextEditor::backgroundColourId, juce::Colours::darkgrey);
