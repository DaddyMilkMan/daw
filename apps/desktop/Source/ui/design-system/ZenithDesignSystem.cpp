...
void ThemeManager::loadTheme(const juce::String &name) {
  ...
  if (auto *obj = json.getDynamicObject()) {
    ...
    if (obj->hasProperty("CYAN"))
      colors::CYAN = (uint32_t)(juce::int64)obj->getProperty("CYAN");
    if (obj->hasProperty("MAGENTA"))
      colors::MAGENTA =
          (uint32_t)(juce::int64)obj->getProperty("MAGENTA");
    if (obj->hasProperty("NEON_GREEN"))
      colors::NEON_GREEN =
          (uint32_t)(juce::int64)obj->getProperty("NEON_GREEN");
    if (obj->hasProperty("BG_DARKEST"))
      colors::BG_DARKEST =
          (uint32_t)(juce::int64)obj->getProperty("BG_DARKEST");
    if (obj->hasProperty("BG_DARKER"))
      colors::BG_DARKER =
          (uint32_t)(juce::int64)obj->getProperty("BG_DARKER");
    if (obj->hasProperty("BG_DARK"))
      colors::BG_DARK =
          (uint32_t)(juce::int64)obj->getProperty("BG_DARK");
