...
/** Lightbulb icon for ideas/suggestions */
inline SkPath Lightbulb() {
  SkPath path;

  // Bulb outline
  path.addCircle(12.0f, 9.0f, 5.0f);

  // Neck/base
  path.moveTo(9.5f, 14.0f);
  path.lineTo(9.5f, 16.0f);
  path.lineTo(14.5f, 16.0f);
  path.lineTo(14.5f, 14.0f);

  // Filament
  path.moveTo(10.5f, 10.0f);
  path.lineTo(13.5f, 10.0f);
  path.moveTo(11.0f, 11.8f);
  path.lineTo(13.0f, 11.8f);

  // Bottom cap
  path.moveTo(10.0f, 18.0f);
  path.lineTo(14.0f, 18.0f);
  path.moveTo(10.5f, 19.5f);
  path.lineTo(13.5f, 19.5f);

  // Tiny rays
  path.moveTo(12.0f, 1.8f);
  path.lineTo(12.0f, 3.6f);
  path.moveTo(5.0f, 6.8f);
  path.lineTo(6.5f, 7.8f);
  path.moveTo(19.0f, 6.8f);
  path.lineTo(17.5f, 7.8f);
...
/** Wingman icon - sourced from Content/Icons/wing_fill.svg */
inline SkPath Wingman() {
  static const char *kWingPath1 =
      "M 802 283 L 791 297 L 762 324 L 738 340 L 703 358 L 672 371 L 623 388 "
      "L 510 421 L 463 437 L 411 460 L 367 487 L 342 507 L 317 532 L 286 574 "
      "L 271 602 L 260 628 L 251 659 L 248 679 L 253 663 L 269 628 L 281 608 "
      "L 301 580 L 326 554 L 342 540 L 381 514 L 427 492 L 476 476 L 548 460 "
      "L 617 448 L 658 438 L 705 421 L 740 401 L 764 380 L 774 368 L 784 352 "
      "L 797 318 Z";
  static const char *kWingPath2 =
      "M 727 445 L 707 457 L 701 459 L 694 463 L 657 475 L 645 477 L 644 478 "
      "L 640 478 L 636 480 L 617 483 L 616 484 L 611 484 L 605 486 L 595 487 "
      "L 594 488 L 582 489 L 581 490 L 576 490 L 575 491 L 570 491 L 569 492 "
      "L 554 493 L 553 494 L 548 494 L 547 495 L 543 495 L 537 497 L 520 499 "
      "L 519 500 L 490 505 L 485 507 L 481 507 L 480 508 L 469 510 L 465 512 "
      "L 461 512 L 419 526 L 383 543 L 353 562 L 337 575 L 320 592 L 309 605 "
      "L 319 596 L 330 588 L 355 573 L 387 559 L 412 551 L 415 551 L 424 548 "
      "L 428 548 L 437 545 L 446 544 L 447 543 L 452 543 L 453 542 L 458 542 "
      "L 459 541 L 464 541 L 465 540 L 473 540 L 474 539 L 497 538 L 498 537 "
      "L 514 537 L 515 536 L 529 536 L 530 535 L 545 535 L 546 534 L 566 534 "
      "L 567 533 L 580 533 L 581 532 L 608 530 L 609 529 L 615 529 L 616 528 "
      "L 626 527 L 657 518 L 676 509 L 684 504 L 688 500 L 692 498 L 707 483 "
      "L 713 475 L 716 468 L 718 466 Z";
  static const char *kWingPath3 =
      "M 604 560 L 603 560 L 602 561 L 600 561 L 599 562 L 595 562 L 594 563 "
      "L 591 563 L 590 564 L 585 564 L 584 565 L 578 565 L 577 566 L 571 566 "
      "L 570 567 L 560 567 L 559 568 L 508 568 L 507 569 L 477 569 L 476 570 "
      "L 464 570 L 463 571 L 453 571 L 452 572 L 444 572 L 443 573 L 437 573 "
      "L 436 574 L 430 574 L 429 575 L 425 575 L 424 576 L 420 576 L 419 577 "
      "L 415 577 L 414 578 L 411 578 L 410 579 L 407 579 L 406 580 L 403 580 "
      "L 402 581 L 399 581 L 398 582 L 396 582 L 395 583 L 393 583 L 392 584 "
      "L 390 584 L 389 585 L 387 585 L 386 586 L 384 586 L 383 587 L 378 588 "
      "L 375 590 L 373 590 L 368 593 L 366 593 L 365 594 L 364 594 L 363 595 "
      "L 362 595 L 361 596 L 350 601 L 348 603 L 347 603 L 345 605 L 342 606 "
      "L 339 609 L 338 609 L 336 611 L 335 611 L 331 614 L 332 614 L 333 613 "
      "L 335 613 L 338 611 L 340 611 L 341 610 L 343 610 L 344 609 L 346 609 "
      "L 347 608 L 352 607 L 355 605 L 358 605 L 359 604 L 362 604 L 363 603 "
      "L 366 603 L 367 602 L 370 602 L 371 601 L 374 601 L 375 600 L 379 600 "
      "L 380 599 L 384 599 L 385 598 L 391 598 L 392 597 L 400 597 L 401 596 "
      "L 415 596 L 416 595 L 444 595 L 445 596 L 463 596 L 464 597 L 477 597 "
      "L 478 598 L 489 598 L 490 599 L 503 599 L 504 600 L 532 600 L 533 599 "
      "L 542 599 L 543 598 L 548 598 L 549 597 L 553 597 L 554 596 L 557 596 "
      "L 558 595 L 560 595 L 561 594 L 566 593 L 567 592 L 578 587 L 580 585 "
      "L 581 585 L 583 583 L 584 583 L 588 579 L 589 579 L 591 577 L 591 576 "
      "L 599 568 L 599 567 L 602 564 L 602 563 Z";

  SkPath combined;
  SkPath part;
  if (SkParsePath::FromSVGString(kWingPath1, &part))
    combined.addPath(part);
  part.reset();
  if (SkParsePath::FromSVGString(kWingPath2, &part))
    combined.addPath(part);
  part.reset();
  if (SkParsePath::FromSVGString(kWingPath3, &part))
    combined.addPath(part);

  SkMatrix scaleMatrix;
  scaleMatrix.setScale(ICON_VIEWPORT / 1024.0f, ICON_VIEWPORT / 1024.0f);
  combined.transform(scaleMatrix);
  return combined;
}
...
inline SkPath History() {
  ...
  path.lineTo(12.0f, 8.5f);
  path.moveTo(12.0f, 12.0f);
  path.lineTo(14.8f, 13.8f);
  // Counterclockwise history arrow at top-left
  path.moveTo(6.5f, 5.5f);
  path.lineTo(3.8f, 5.5f);
  path.lineTo(3.8f, 8.2f);
  return path;
}
inline SkPath SendArrowUp() { return SendArrow(); }
inline SkPath Refresh() {
  SkPath path;
  path.moveTo(12.0f, 4.0f);
  path.arcTo(8.0f, 8.0f, 0.0f, SkPath::kSmall_ArcSize, SkPathDirection::kCW, 20.0f, 12.0f);
  path.moveTo(20.0f, 8.0f);
  path.lineTo(20.0f, 12.0f);
  path.lineTo(16.0f, 12.0f);
  path.moveTo(12.0f, 20.0f);
  path.arcTo(8.0f, 8.0f, 0.0f, SkPath::kSmall_ArcSize, SkPathDirection::kCW, 4.0f, 12.0f);
