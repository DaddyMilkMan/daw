 ...
 * @brief Implementation of production UI theme system
...
//==============================================================================
// Color Palette Definitions (sourced from ZenithDesignSystem)
//==============================================================================
...
const juce::Colour ZenithTheme::Colors::hover_overlay =
    design::toJuceColour(design::colors::TEXT_PRIMARY).withAlpha(design::opacity::HOVER);
