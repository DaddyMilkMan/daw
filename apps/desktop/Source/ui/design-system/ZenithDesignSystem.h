/*
  ==============================================================================
    ...
    The complete production design system for Zenith DAW.
    Focus: readable hierarchy, durable spacing, restrained accents.
...
// ============================================================================
// COLOR PALETTE (Mutable for Theming)
// ============================================================================
...
// Brand Colors
inline SkColor CYAN = 0xFF3B82F6;        // Professional Blue (Primary Brand)
inline SkColor MAGENTA = 0xFF8B5CF6;     // Muted Violet (Secondary Brand)
...
// Legacy translucent surface tokens (kept for compatibility)
...
inline SkColor FOCUS_RING_COLOR = colors::CYAN;  // Primary blue focus ring with AA-compliant contrast
...
enum class ThemePreset {
  Dark,   // Premium matte-black theme with restrained blue accents
