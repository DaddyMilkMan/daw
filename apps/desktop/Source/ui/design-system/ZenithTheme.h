/**
 * @file ZenithTheme.h
 * @brief Production UI theme system for Zenith DAW
 * @author Fixed by Claude - December 2025
 *
 * Professional design token system with clear hierarchy, spacing, and
...
/**
 * @class ZenithTheme
 * @brief Design tokens with consistent visual hierarchy
 */
class ZenithTheme {
public:
  //==========================================================================
  ...
  struct Colors {
    ...
    static const juce::Colour accent_secondary; // #8b5cf6 - Secondary accent
    ...
    static const juce::Colour hover_overlay; // Subtle hover overlay for surfaces
  ...
  //==========================================================================
  // Shadow System (for depth/elevation; keep usage restrained)
  //==========================================================================
  struct Shadows {
