...
ExportDialog::ExportDialog(CommandAPI &commandAPI) : commandAPI_(commandAPI) {
  ...
  btnFlac_->onClick = [this]() {
    selectedFormat_ = "flac";
    updateButtonStates();
  };
  ...
  btn16Bit_->onClick = [this]() {
    selectedBitDepth_ = 16;
    updateButtonStates();
  };
  ...
  btn24Bit_->onClick = [this]() {
    selectedBitDepth_ = 24;
    updateButtonStates();
  };
  ...
  btn32Bit_->onClick = [this]() {
    selectedBitDepth_ = 32;
    updateButtonStates();
  };
