...
class WingmanSidePanel : public SkiaComponent {
public:
  WingmanSidePanel(CommandAPI &api, Engine &engine, ProjectState &projectState);
  ~WingmanSidePanel() override;
...
private:
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(WingmanSidePanel)
};
