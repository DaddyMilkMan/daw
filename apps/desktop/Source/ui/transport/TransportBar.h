/*
  ==============================================================================
    ...
    Transport controls for Zenith DAW's premium matte-black UI.
...
private:
  ...
  enum class EditTarget { None, BPM, TimeSigNum, TimeSigDen };
  EditTarget activeEditTarget_ = EditTarget::None;
  ...
  InteractionState browserState_;
  ...
  void drawTransportButton(SkCanvas *canvas, const juce::Rectangle<int> &bounds,
                           ...
                           bool allowFill = true, bool forceFilled = false);
