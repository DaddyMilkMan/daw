...
void CollabPanel::drawSkia(SkCanvas* canvas) {
    ...
    drawButton(canvas, hostButtonBounds_, "Start Hosting",
               state == CollaborationManager::ConnectionState::Registering ||
                   state == CollaborationManager::ConnectionState::GatheringICE ||
                   state == CollaborationManager::ConnectionState::ExchangingCandidates ||
                   state == CollaborationManager::ConnectionState::ICEConnecting,
               design::unified::accent_primary());

    if (state == CollaborationManager::ConnectionState::Registering ||
        state == CollaborationManager::ConnectionState::GatheringICE ||
        state == CollaborationManager::ConnectionState::ExchangingCandidates ||
        state == CollaborationManager::ConnectionState::ICEConnecting ||
        state == CollaborationManager::ConnectionState::Handshaking ||
...
void CollabPanel::mouseDown(const juce::MouseEvent& e) {
    ...
    auto& mgr = CollaborationManager::getInstance();
    if (mgr.getState() == CollaborationManager::ConnectionState::Registering ||
        mgr.getState() == CollaborationManager::ConnectionState::GatheringICE ||
        mgr.getState() == CollaborationManager::ConnectionState::ExchangingCandidates ||
        mgr.getState() == CollaborationManager::ConnectionState::ICEConnecting ||
        mgr.getState() == CollaborationManager::ConnectionState::Handshaking ||
...
void CollabPanel::drawStatusIndicator(SkCanvas* canvas,
    ...
    switch (state) {
        ...
        case CollaborationManager::ConnectionState::Registering:
            ...
            break;
        case CollaborationManager::ConnectionState::GatheringICE:
            statusText = "Gathering ICE Candidates...";
            statusColor = design::unified::accent_secondary();
            break;
        case CollaborationManager::ConnectionState::ExchangingCandidates:
            statusText = "Exchanging Candidates...";
            statusColor = SkColorSetRGB(255, 150, 50);
            break;
        case CollaborationManager::ConnectionState::ICEConnecting:
            statusText = "Checking Connectivity...";
        ...
        case CollaborationManager::ConnectionState::Connected:
            ...
            break;
        case CollaborationManager::ConnectionState::Failed:
