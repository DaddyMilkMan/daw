/*
  ==============================================================================
    ...
    Accent glow effect utilities for Zenith DAW's premium dark visual language.
...
/**
 * @brief Accent glow effect rendering utilities
 *
 * Provides restrained accent lighting throughout the UI:
 * - Outer glows for focused controls and high-value actions
 * - Text glows for headers and important labels when emphasis is needed
 * - Active element indicators
 * - Animated pulse effects for alerts and transport feedback
 */
class NeonGlow {
public:
