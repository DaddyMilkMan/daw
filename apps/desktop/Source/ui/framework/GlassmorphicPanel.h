/*
  ==============================================================================
    ...
    Selective glass-surface rendering utilities for Zenith DAW's premium dark UI.
...
/**
 * @brief Glass-surface rendering utilities with real backdrop blur
 *
 * Provides selective glass-effect panels for overlays and elevated surfaces with:
 ...
 * BEFORE this panel, creating authentic elevated surfaces only where they help.
 */
...
public:
  enum class Style {
    ...
    ActiveGlow // Glass with restrained accent border (16px blur, focused/active
               // elements)
  };
