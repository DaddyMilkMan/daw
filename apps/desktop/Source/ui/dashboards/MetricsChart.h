...
private:
    ...
    juce::Colour lineColor = juce::Colour(0xFF3B82F6);        // Primary blue accent
    ...
    juce::Colour glowColor = juce::Colour(0xFF3B82F6);        // Focus glow
    juce::Colour gradientTopColor = juce::Colour(0x403B82F6); // Gradient fill top
    juce::Colour gradientBottomColor = juce::Colour(0x003B82F6); // Gradient fill bottom
    
    // Modern color palette for multi-series
    std::vector<juce::Colour> seriesColors = {
        juce::Colour(0xFF3B82F6),  // Blue
        juce::Colour(0xFF8B5CF6),  // Blue-violet
        juce::Colour(0xFF06B6D4),  // Teal
        juce::Colour(0xFF64748B),  // Slate
