...
{
    static const juce::StringArray validTypes = {
...
bool PresetGenerator::isValidModSource(const juce::String& source)
{
    static const juce::StringArray validSources = {
        "none", "lfo1", "lfo2", "env1", "env2", "velocity", "modwheel", "aftertouch"
    };
...
bool PresetGenerator::isValidModDestination(const juce::String& destination)
{
    static const juce::StringArray validDestinations = {
        "none", "filter_cutoff", "filter_resonance", "osc1_pitch", "osc2_pitch",
...
bool PresetGenerator::validatePresetParameters(
...
juce::var PresetGenerator::getParameterSchema(const juce::String& instrumentId)
{
    if (instrumentId != "zenith_poly_synth")
...
juce::String PresetGenerator::detectSoundType(const juce::String& description)
{
    ...
    if (lower.contains("pad") || lower.contains("ambient") || lower.contains("atmosphere"))
        return "pad";
...
juce::var PresetGenerator::clampParameter(
