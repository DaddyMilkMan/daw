...
#endif
{
  ...
  DBG("✓ TransportBar created and made visible at " +
      juce::String::toHexString(static_cast<juce::pointer_sized_int>(transportBar.get())));
  ...
  DBG("✓ MainLayoutComponent created and made visible at " +
      juce::String::toHexString(static_cast<juce::pointer_sized_int>(mainLayout.get())));
  ...
  DBG("✓ RightSidePanel created and made visible at " +
      juce::String::toHexString(static_cast<juce::pointer_sized_int>(rightSidePanel.get())));
  ...
  DBG("✓ BottomBar created and made visible at " +
      juce::String::toHexString(static_cast<juce::pointer_sized_int>(bottomBar.get())));
