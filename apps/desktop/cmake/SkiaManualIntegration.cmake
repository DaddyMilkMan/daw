...
if(NOT DEFINED SKIA_ROOT)
    ...
    elseif(CMAKE_PREFIX_PATH)
        ...
        # Try local vcpkg in project directory first
        if(EXISTS "${CMAKE_SOURCE_DIR}/external/vcpkg/installed/x64-linux/include/skia")
            set(SKIA_ROOT "${CMAKE_SOURCE_DIR}/external/vcpkg/installed/x64-linux")
            message(STATUS "  SKIA_ROOT: From local vcpkg (external/vcpkg)")
        else()
