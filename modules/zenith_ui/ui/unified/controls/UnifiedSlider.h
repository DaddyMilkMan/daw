...
public:
    ...
    public:
        ...
        Builder& withTextBoxStyle(juce::Slider::TextEntryBoxPosition style);
    ...
    private:
        ...
        juce::Slider::TextEntryBoxPosition textBoxStyle_{juce::Slider::TextBoxRight};
     ...
     */
    void setTextBoxStyle(juce::Slider::TextEntryBoxPosition style);

    /**
     // Brief: Get the text box style
     * @return The text box style
     */
    juce::Slider::TextEntryBoxPosition getTextBoxStyle() const { return textBoxStyle_; }
...
private:
    ...
    juce::Slider::TextEntryBoxPosition textBoxStyle_;
    bool dragging_;
    bool hovered_;
    bool focused_;
