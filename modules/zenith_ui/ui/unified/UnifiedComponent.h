...
#undef ZENITH_ENABLE_SKIA
#undef ZENITH_USE_SKIA

#include "IUnifiedComponent.h"
// TODO: Fix SkiaComponent.h include
...
public:
    using Theme = zenith::design::ThemeManager::Theme;
...
protected:
    ...
    juce::ListenerList<juce::ComponentListener> listeners_;
    ...
    // Animation callback
    virtual void onUpdateAnimation(float value);
