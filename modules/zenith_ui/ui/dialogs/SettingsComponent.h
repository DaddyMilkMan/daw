...
private:
    ...
    // Model Mode Section
    std::unique_ptr<SkiaComboBox> modelModeSelector_;

    // Feature Toggles Section
    std::unique_ptr<SkiaButton> reasoningDisplayToggle_;
    std::unique_ptr<SkiaButton> webSearchToggle_;
    std::unique_ptr<SkiaButton> streamingToggle_;
    std::unique_ptr<SkiaButton> dawContextToggle_;

    // Context Management Section
    std::unique_ptr<SkiaSlider> historyLengthSlider_;
};
