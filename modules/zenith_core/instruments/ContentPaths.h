...
public:
   ...
   */
  juce::File
  getInstrumentTypeDirectory(const juce::String &instrumentType) const {
   ...
   */
  juce::StringArray
  getAvailablePatches(const juce::String &instrumentType) const {
    ...
    instrumentDir.findChildFiles(subdirs, juce::File::findDirectories, false);
...
private:
  ...
  static juce::File getDefaultContentRoot() {
    ...
    if (!defaultDir.exists()) {
      // Traverse up from modules/zenith_core/instruments/ContentPaths.h to root
      juce::File sourceFile(__FILE__);
      juce::File repoDir = sourceFile
                               .getParentDirectory() // instruments
                               .getParentDirectory() // zenith_core
                               .getParentDirectory() // modules
