/*
  ==============================================================================
    ...
    Implementation of the SkiaKnob component.
...
void SkiaKnob::drawSkia(SkCanvas* canvas) {
    ...
    float totalEndAngle = startAngle + rotationRange_;
    ...
    if (valueColoring_) {
        ...
        color = design::interpolate(design::colors::BLUE, design::colors::CYAN, value_);
    }
    ...
    if (labelPosition_ != LabelPosition::None) {
        ...
        canvas->drawString(labelText.toRawUTF8(), cx - width / 2, textY, font, textPaint);
    }
}
