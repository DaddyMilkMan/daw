/*
  ==============================================================================
    ...
    - Value display (Yuki vs Leo) - 3 arguments
    - Modulation visualization (Zara vs everyone) - 4 arguments
...
/**
 * A beautiful rotary knob control with arc rendering.
 * 
 * ARC ARGUMENT #1: Should the arc be filled or stroked?
 * - Leo: "FILLED! With gradient! And GLOW!"
 * - Yuki: "Stroked! Clean and minimal!"
 * - Dr. Aris: "Filled is more expensive to render..."
