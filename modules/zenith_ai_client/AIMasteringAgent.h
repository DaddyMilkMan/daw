...
private:
  void analyzeFrequencyBands(const juce::AudioBuffer<float> &buffer,
                             double sampleRate, Features &features);
...
public:
  ...
  void analyzeAndConfigure(const juce::AudioBuffer<float> &analysisBuffer,
