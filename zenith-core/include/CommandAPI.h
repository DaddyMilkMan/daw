...
private:
     ...
     * Params: { "trackId": "track_0", "startBeats": 0.0, "lengthBeats": 4.0, "type": "audio"|"midi" }
     ...
     * Returns: { "clips": [ { "id": "...", "startBeats": 0.0, "lengthBeats": 4.0, "type": "audio" }, ... ] }
     */
     ...
     * Params: { "trackId": "track_0", "clipId": "clip_123" }
     * Returns: { "notes": [ { "id": "...", "note": 60, "velocity": 100, "startBeats": 0.0, "lengthBeats": 1.0 }, ... ] }
     */
    juce::var cmd_getClipNotes(const juce::var& params);

    // Plugin commands (stubbed - plugins not yet implemented in Track.h)
    /**
     ...
     * Returns: { "success": false, "message": "Export functionality not yet implemented" }
     */
