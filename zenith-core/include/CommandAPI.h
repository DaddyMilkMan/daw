...
private:
   ...
   * Params: { "trackId": "track_1", "param": "volume", "timeBeats": 8.0,
   * "value": 0.5 } Returns: { "pointId": "point_123" }
   */
   ...
   * Params: { "outputPath": "/path/to/output.wav", "durationSeconds": 10.0,
   * "sampleRate": 44100.0 } Returns: { "success": true }
   */
   ...
   * Params: { "trackId": "track_0", "clipId": "clip_123", "path":
   * "/path/to/audio.wav" } Returns: { "success": true }
   */
   ...
   * Params: { "trackId": "track_0", "startBeats": 0.0, "lengthBeats": 4.0,
   * "path": "/path/to/audio.wav" } Returns: { "clipId": "clip_123" }
   */
  ...
  /**
   * @brief Add MIDI note
   * Params: { "clipId": "clip_1", "startBeats": 0.0, "lengthBeats": 1.0,
   * "pitch": 60, "velocity": 100 } Returns: { "noteId": "note_123" }
   */
  juce::var cmd_addNote(const juce::var &params);

  /**
   * @brief Move/edit MIDI note
   * Params: { "clipId": "clip_1", "noteId": "note_1", "startBeats": 0.0,
   * "lengthBeats": 1.0, "pitch": 60, "velocity": 100 } Returns: { "success":
   * true }
   */
   ...
   * Params: { "trackId": "track_0", "clipId": "clip_123", "note": 60,
   * "velocity": 100, "startBeats": 0.0, "lengthBeats": 1.0 } Returns: {
   * "success": false, "message": "MIDI note API not yet implemented in
   * ProjectState" }
   */
   ...
   * Params: { "clipId": "clip_1", "noteId": "note_1" } OR { "trackId":
   * "track_0", "clipId": "clip_123", "noteId": "note_123" } Returns: {
   * "success": true }
   */
   ...
   * Returns: { "notes": [ { "id": "...", "startBeats": 0.0, "lengthBeats": 1.0,
   ...
   * Params: { "type": "instrument"|"effect", "searchTerm": "..." } (all
   * optional) Returns: { "plugins": [] }
   */
   ...
   * Params: { "path": "/path/to/output.wav", "startBeats": 0.0,
   * "endBeats": 16.0 } (start/end optional) Returns: { "success": true,
   * "outputPath": "..." }
   */
   ...
   * Params: { "instrumentId": "zenith_poly_synth", "category": "...", "tag":
   * "..." } (category/tag optional) Returns: { "presets": [{ "id": "...",
   * "name": "...", "category": "...", "tags": [...] }, ...] }
   */
   ...
   * Params: { "trackId": "track_0", "instrumentId": "...", "presetId": "..." }
   * (instrumentId optional if track has instrument) Returns: { "success": true
   * }
   */
   ...
   * Params: { "trackId": "track_0", "name": "My Preset", "category": "...",
   * "tags": [...] } (category/tags optional) Returns: { "success": true,
   * "presetId": "..." }
   */
   ...
   * Params: { "trackId": "track_0" }
   * Returns: { "parameters": [{ "id": "...", "name": "...", "min": 0, "max": 1,
   * "default": 0.5, "value": 0.7, "tags": [...] }, ...] }
   */
  juce::var cmd_getInstrumentParameters(const juce::var &params);

  /**
   * @brief Set multiple instrument parameters at once
   * Params: { "trackId": "track_0", "params": { "filter_cutoff": 0.8,
   * "filter_resonance": 0.3 } } Returns: { "success": true, "updated":
   ...
   * Returns: { "paramId": "filter_cutoff", "value": 0.65, "min": 0.0,
   * "max": 1.0 }
   */
   ...
   * Params: { "trackId": "track_0", "intensity": 0.5 } (intensity optional,
   * 0.0-1.0) Returns: { "success": true, "randomized": ["filter_cutoff",
   * "filter_resonance", ...] }
   */
   ...
   * Params: { "beatPosition": 8.0, "bpm": 140.0, "timeSigNumerator": 4,
   * "timeSigDenominator": 4 } Returns: { "tempoId": "tempo_123" }
   */
   ...
   * @brief Get tempo map
   * Params: {}
   * Returns: { "tempoChanges": [ { "id": "...", "beatPosition": 0.0, "bpm":
   * 120.0, ... }, ... ] }
   */
   ...
   * @brief Get markers
   * Params: {}
   * Returns: { "markers": [ { "id": "...", "name": "...", "beatPosition": 0.0,
   * "color": "..." }, ... ] }
   */
