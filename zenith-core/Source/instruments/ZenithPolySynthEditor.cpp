...
void ZenithPolySynthEditor::setupPresetBrowser()
{
    ...
    presetBrowser_->setLoadPresetCallback([this](const zenith::Preset& preset)
    {
...
zenith::Preset ZenithPolySynthEditor::captureCurrentState() const
{
    ...
    preset.name = "User Preset"; // Default name, will be overwritten by save dialog
    preset.author = "User";
    ...
    // For now assuming macros are part of parameters or handled by instrument_.getParameter
