...
juce::Font ZenithTheme::Typography::getHeadingFont() {
    return juce::FontOptions(heading).withStyle(juce::Font::bold);
}

juce::Font ZenithTheme::Typography::getLargeFont() {
    return juce::FontOptions(large).withStyle(juce::Font::bold);
}

juce::Font ZenithTheme::Typography::getDisplayFont() {
    return juce::FontOptions(display).withStyle(juce::Font::bold);
}
