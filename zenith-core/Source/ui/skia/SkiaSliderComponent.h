 ...
 */
class SkiaSliderComponent : public juce::Component, private juce::Timer {
public:
  /**
   * Slider orientation
   */
   ...
   */
  [[maybe_unused]] void setNumSteps(int steps);

  /**
   * @brief Enable/disable value snapping
   */
  [[maybe_unused]] void setSnapToValue(bool snap) { snapToValue_ = snap; }
   ...
   */
  [[maybe_unused]] void setShowValue(bool show) { showValue_ = show; }

  /**
   * @brief Set value display precision
   */
  [[maybe_unused]] void setTextPrecision(int decimals) {
    textPrecision_ = decimals;
  }
