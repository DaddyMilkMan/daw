...
private:
  void drawPlayButton(juce::Graphics& g, int x, int y, int width, int height);
  void drawStopButton(juce::Graphics& g, int x, int y, int width, int height);
  void drawRecordButton(juce::Graphics& g, int x, int y, int width, int height);
