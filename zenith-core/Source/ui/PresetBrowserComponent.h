...
// Note: Skia rendering enabled for other components but buttons use JUCE for
// now
 ...
 */
class PresetBrowserComponent : public juce::Component, public juce::Timer {
public:
  //==========================================================================
  // Constructor
  //==========================================================================
   ...
   */
  void setLoadPresetCallback(
      std::function<void(const ZenithInstrumentPreset &)> callback) {
...
private:
  ...
  public:
    ...
    [[maybe_unused]] void returnKeyPressed(int lastRowSelected) override;
