...
private:
  ...
  void drawPianoKeysSkia(SkCanvas &canvas, float x, float y, float width,
                         float height);
  ...
  void drawZebraStripingSkia(SkCanvas &canvas,
  ...
  void createNote(int noteNumber, double startBeats, double lengthBeats,
                  int velocity) [[maybe_unused]];
