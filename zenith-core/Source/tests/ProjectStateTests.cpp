...
public:
    ValueTreeIntegrityTests() : juce::UnitTest("ValueTree Integrity", "ProjectState") {}
...
public:
    ...
    void runTest() override {
        ...
        begin Test("Undo with child operations");
        {
            juce::UndoManager undoManager;
            juce::ValueTree parent("Parent");
...
public:
    TrackManipulationTests() : juce::UnitTest("Track Manipulation", "ProjectState") {}
...
public:
    ClipManipulationTests() : juce::UnitTest("Clip Manipulation", "ProjectState") {}
...
public:
    ProjectSerializationTests() : juce::UnitTest("Project Serialization", "ProjectState") {}
