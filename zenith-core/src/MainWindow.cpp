    ...
    : engine(eng), projectState(ps)
{
    ...
    // Phase 14: Create arranger component
...
void MainComponent::resized()
{
    ...
    // Phase 14: Arranger component fills remaining space
                     ...
                     DocumentWindow::allButtons)
{
    ...
    // Create main content (Phase 14: pass ProjectState for automation lanes)
