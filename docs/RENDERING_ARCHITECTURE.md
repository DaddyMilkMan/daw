...
public:
    ...
    // JUCE paint() required by base class but not used
...
- `paint(juce::Graphics& g)` override required by JUCE but provides no functionality
- **ZenithLookAndFeel** is deprecated - kept only for legacy utility components
