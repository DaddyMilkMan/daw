...
```bash
# Scan entire project
python agents/LintingAgent/linting_agent.py

# Scan specific directory
python agents/LintingAgent/linting_agent.py apps/desktop/Source

# Scan with glob patterns
python agents/LintingAgent/linting_agent.py "**/*.cpp" "**/*.h"

# Fail on errors (useful for CI)
python agents/LintingAgent/linting_agent.py --fail-on-error

# Exclude directories
python agents/LintingAgent/linting_agent.py --exclude build external _deps
```
...
```bash
# Future feature
python agents/LintingAgent/linting_agent.py --fix
```
