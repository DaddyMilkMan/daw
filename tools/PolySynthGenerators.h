...
#include <random>
#include <cmath>
#include <sstream> // For serializePresetToJSON
#include <iomanip> // For std::setprecision

// Forward declaration of JUCE classes if needed by including files later
// This header should be as standalone as possible

namespace PolySynthPresetGen
{
...
private:
    ...
    void initializeCategoryDefinitions()
    {
        ...
        // Metal Bell
        {
            ...
            cat.paramRanges["amp_decay"] = {0.3f, 0.6f};
            cat.paramRanges["amp_sustain"] = {0.2f, 0.5f};
            cat.paramRanges["amp_release"] = {0.0f, 0.8f}; // Changed from 0.4f to 0.0f for more variety
